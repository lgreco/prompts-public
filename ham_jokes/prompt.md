...
The Dutchman's frugality (money, prices, bargain-hunting, "cheap Dutch" framing) is a generic stereotype reserved for the Baseline section only — it is not one of his specific character traits, and it has become a predictable crutch in main-attempt jokes. Do not use it as a punchline device for the specific-character Dutchman; draw his humor from his actual traits instead (newest to the hobby, cylinder count, DMR/Netherlands net, IT executive background, sailing history, late-life guitar).

Also tone down jokes that turn on the license-level gap between the Dutchman and the other two (Technician/General vs. Extra). It's fine to note he's newest to the hobby, but don't frame his General license itself as insufficient, unearned, or something to be dismissed until he "upgrades past" it — that downplays a real accomplishment rather than landing an earned jab.
