...
The prompts are typed up as markdown (`.md`) files. To use a prompt, it's best to download it or switch to raw view then copy/paste, instead of copying the static HTML rendering.

Any improvement suggestions (or pull requests) are greatly appreciated and enthusiastically acknowledged.
